@if(auth()->check() && (auth()->user()->rol === 'jefe' || auth()->user()->rol === 'reclutador'))
    ...
    <div class="w-full">
        ...
        <div
            class="mb-6 bg-gradient-to-r from-celeste to-celeste rounded-lg p-5 border-2 border-azul-noche border-opacity-20">
            <h3 class="text-lg font-semibold mb-4 text-azul-noche flex items-center">
                <i class="fas fa-id-card mr-2 text-naranja"></i>
                Tipo de Documento
            </h3>
            <div class="mb-4">
                <label class="block text-sm font-medium text-azul-noche mb-2">Selecciona el tipo de documento <span
        ...
        <div id="busqueda-dni-section"
            ...
            <div class="flex gap-3 items-end">
                <div class="flex-1">
                    ...
                    <input id="dni-input" type="text" placeholder="Ingresa el DNI (8 dígitos)" maxlength="8"
                        class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                </div>
                <button id="btn-buscar" type="button"
                    class="bg-naranja hover:bg-naranja hover:bg-opacity-90 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg flex items-center">
        ...
        <div id="formulario-extranjeria-section"
            class="mb-6 bg-gradient-to-r from-celeste to-celeste rounded-lg p-5 border-2 border-azul-noche border-opacity-20"
            style="display: none;">
            <h3 class="text-lg font-semibold mb-4 text-azul-noche flex items-center">
            ...
            <div class="flex gap-3 items-end">
                <div class="flex-1">
                    ...
                    <input id="carnet-input" type="text" placeholder="Ingresa el número de carnet"
                        class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                </div>
                <button id="btn-continuar-extranjeria" type="button"
                    class="bg-naranja hover:bg-naranja hover:bg-opacity-90 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg flex items-center">
        ...
        <form id="postulante-form">
            @csrf
            <!-- Campo oculto para guardar el valor numérico del sexo (1 o 2) -->
            <input type="hidden" id="sexo_numeric" name="sexo_numeric" value="">
            ...
            <div class="mb-6 bg-gray-50 rounded-lg p-5 border border-gray-200">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Nombres <span
                                class="text-naranja campo-requerido">*</span></label>
                        <input name="nombres" id="nombres"
                            class="border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Apellido Paterno <span
                                class="text-naranja campo-requerido">*</span></label>
                        <input name="ap_pat" id="ap_pat"
                            class="border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Apellido Materno <span
                                class="text-naranja campo-requerido">*</span></label>
                        <input name="ap_mat" id="ap_mat"
                            class="border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Número de Documento <span
                                class="text-naranja campo-requerido">*</span></label>
                        <input name="dni" id="documento-numero"
                            class="border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Fecha de Nacimiento <span
                                class="text-naranja campo-requerido">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Sexo / Género <span
                                class="text-naranja campo-requerido">*</span></label>
                        <!-- Para DNI: readonly input (solo visual, no se envía) -->
                        <input type="text" id="sexo-readonly"
                            class="sexo-field-dni border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                        <!-- Para Carnet: select editable -->
                        <select name="sexo" id="sexo-select"
                            class="sexo-field-carnet border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            style="display: none;">
                    ...
                    <div class="col-span-2">
                        <label class="block text-sm font-medium text-azul-noche mb-2">Dirección <span
                                class="text-naranja campo-requerido">*</span></label>
                    ...
                    <div>
                        ...
                        <!-- Para DNI: readonly input (solo visual, no se envía) -->
                        <input type="text" id="est_civil-readonly"
                            class="est-civil-field-dni border-2 border-azul-noche border-opacity-20 bg-white p-3 w-full rounded-lg text-azul-noche cursor-not-allowed campo-personal"
                            readonly />
                        <!-- Para Carnet: select editable -->
                        <select name="est_civil" id="est_civil-select"
                            class="est-civil-field-carnet border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            style="display: none;">
                    ...
                    <div id="nacionalidad-container" style="display: none;">
                        <label class="block text-sm font-medium text-azul-noche mb-2">Nacionalidad <span
                                class="text-naranja">*</span></label>
                        <input name="nacionalidad" id="nacionalidad"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6" id="additional-fields" style="display: none;">
                <div class="bg-celeste border-l-4 border-naranja p-4 mb-4 rounded-r-lg">
                    ...
                    <p class="text-sm text-azul-noche text-opacity-70">Por favor completa todos los campos marcados con
                        <span class="text-naranja font-semibold">*</span>
                    </p>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Número de Contacto <span
                                class="text-naranja">*</span></label>
                        <input name="celular" id="celular" type="tel" placeholder="Ej: 987654321"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            required />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Número de WhatsApp <span
                                class="text-naranja">*</span></label>
                        <input name="whatsapp" id="whatsapp" type="tel" placeholder="Ej: 987654321"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            required />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Correo Electrónico <span
                                class="text-naranja">*</span></label>
                        <input name="correo" id="correo" type="email" placeholder="Ej: correo@ejemplo.com"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            required />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Departamento <span
                                class="text-naranja">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Provincia <span
                    ...
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Distrito <span
                                class="text-naranja">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Experiencia en Call Center <span
                                class="text-red-600">*</span></label>
                        <select name="experiencia_callcenter" id="experiencia_callcenter"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            required>
                            <option value="">Seleccionar</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Discapacidad <span
                                class="text-naranja">*</span></label>
                    ...
                    <div id="tipo_discapacidad_container" style="display: none;">
                        ...
                        <input name="tipo_discapacidad" id="tipo_discapacidad"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Contrato <span
                                class="text-naranja">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Modalidad de Trabajo <span
                                class="text-naranja">*</span></label>
                        <select name="modalidad_trabajo" id="modalidad_trabajo"
                            class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"
                            required>
                            <option value="">Seleccionar</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Gestión (Horario) <span
                                class="text-naranja">*</span></label>
            ...
            <div id="button-container" style="display: none;"
                class="flex gap-3 mt-6 pt-6 border-t border-azul-noche border-opacity-20">
                ...
                <button id="btn-limpiar" type="button"
                    class="bg-azul-noche bg-opacity-60 hover:bg-opacity-80 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                tipoDocumentoSelect.addEventListener('change', function () {
                    ...
                    if (tipoDoc === 'DNI') {
                        ...
                        // Mostrar campos readonly para DNI
                        document.querySelector('.sexo-field-dni').style.display = 'block';
                        document.querySelector('.sexo-field-carnet').style.display = 'none';
                        document.querySelector('.est-civil-field-dni').style.display = 'block';
                        document.querySelector('.est-civil-field-carnet').style.display = 'none';
                        ...
                        // Mostrar campos select para Carnet
                        document.querySelector('.sexo-field-dni').style.display = 'none';
                        document.querySelector('.sexo-field-carnet').style.display = 'block';
                        document.querySelector('.est-civil-field-dni').style.display = 'none';
                        document.querySelector('.est-civil-field-carnet').style.display = 'block';
                    } else {
                        busquedaDniSection.style.display = 'none';
                        formularioExtranjeriaSection.style.display = 'none';
                        nacionalidadContainer.style.display = 'none';
                ...
                function habilitarCamposExtranjeria(carnet) {
                    ...
                    document.getElementById('sexo-select').value = '';
                    document.getElementById('est_civil-select').value = '';
                ...
                document.getElementById('btn-buscar').onclick = async function (event) {
                    ...
                    try {
                        ...
                        if (consultaData.success && consultaData.data) {
                            ...
                            // Mostrar sexo tal cual viene de la API (texto)
                            const sexoInput = document.getElementById('sexo-readonly');
                            if (sexoInput) {
                                // Convertir código numérico a texto legible
                                let sexoTexto = d.sexo || '';
                                if (sexoTexto === '1' || sexoTexto === 1) {
                                    sexoTexto = 'MASCULINO';
                                } else if (sexoTexto === '2' || sexoTexto === 2) {
                                    sexoTexto = 'FEMENINO';
                                }
                                sexoInput.value = sexoTexto;
                            }

                            // Guardar sexo numérico en campo oculto para envío
                            document.getElementById('sexo_numeric').value = d.sexo || '';

                            // Mostrar estado civil tal cual viene de la API (incluyendo "VACIO")
                            const estCivilInput = document.getElementById('est_civil-readonly');
                            if (estCivilInput) {
                                estCivilInput.value = d.est_civil || '';
                            }
                ...
                document.getElementById('btn-guardar').addEventListener('click', function () {
                    ...
                    // Para DNI: usar sexo numérico del campo oculto
                    // Para Carnet: usar el valor del select
                    if (!isExtranjeria) {
                        // DNI: usar sexo_numeric (1 o 2)
                        if (payload.sexo_numeric) {
                            payload.sexo = payload.sexo_numeric;
                        }
                        // est_civil viene del campo readonly, obtenerlo manualmente
                        const estCivilReadonly = document.getElementById('est_civil-readonly');
                        if (estCivilReadonly && estCivilReadonly.value) {
                            payload.est_civil = estCivilReadonly.value;
                        }
                    }
                    // Eliminar campo temporal
                    delete payload.sexo_numeric;

                    console.log('🔍 FINAL - Payload a enviar:', payload);
                    console.log('🔍 isExtranjeria:', isExtranjeria);
                    console.log('🔍 sexo en payload:', payload.sexo);
