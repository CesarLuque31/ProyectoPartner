                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        <div class="space-y-3">
                                                                                                                                                                                                                            <div class="flex items-center justify-between">
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                <div class="flex gap-2">
                                                                                                                                                                                                                                    <a href="/convocatorias/${convocatoriaId}/exportar-excel" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-naranja rounded-lg hover:bg-naranja/90 transition shadow-md hover:shadow-lg">
