@if(auth()->check() && auth()->user()->rol === 'jefe')
    ...
    <div class="p-6 bg-white shadow sm:rounded-lg">
        <h2 class="text-3xl font-bold mb-4 text-azul-noche">Listado de Convocatorias</h2>
        ...
        <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <div class="space-y-4">
                ...
                <div class="flex gap-2">
                    <button type="button" id="btn-aplicar-filtros" class="bg-azul-noche hover:bg-azul-noche hover:bg-opacity-90 text-white px-4 py-2 rounded font-semibold text-sm shadow-md hover:shadow-lg transition-all">
                        Aplicar Filtros
                    </button>
        ...
        <div id="modal-insertar-postulante" class="fixed inset-0 z-50 flex items-center justify-center bg-azul-noche bg-opacity-70 backdrop-blur-sm hidden">
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-5xl relative max-h-[95vh] overflow-hidden flex flex-col border-2 border-azul-noche">
                <!-- Header del Modal -->
                <div class="bg-gradient-to-r from-azul-noche to-azul-noche px-6 py-4 flex items-center justify-between">
                    ...
                    <button id="cerrar-modal-postulante" class="text-white hover:text-amarillo hover:bg-azul-noche hover:bg-opacity-80 rounded-full p-2 transition-colors">
                        <i class="fas fa-times text-xl"></i>
                    </button>
                </div>
                
                <!-- Tabs Navigation -->
                <div class="border-b border-celeste bg-celeste bg-opacity-30">
                    <nav class="flex" aria-label="Tabs">
                        <button id="tab-postulantes" class="flex-1 py-4 px-6 text-center border-b-2 border-naranja text-sm font-semibold text-azul-noche bg-white transition-colors">
                            <i class="fas fa-list mr-2"></i>Lista de Postulantes
                        </button>
                        <button id="tab-insertar" class="flex-1 py-4 px-6 text-center border-b-2 border-transparent text-sm font-semibold text-azul-noche text-opacity-60 hover:text-azul-noche hover:bg-celeste transition-colors">
                ...
                <div class="flex-1 overflow-y-auto">
                    <div id="tab-panel-postulantes" class="tab-panel p-6">
                        ...
                        <div id="modal-postulante-detalle" class="mb-4 p-4 bg-celeste border border-azul-noche border-opacity-20 rounded-lg hidden"></div>
                    </div>
                    <div id="tab-panel-insertar" class="tab-panel hidden p-6">
        ...
        <div id="modal-detalles-convocatoria" class="fixed inset-0 z-50 flex items-center justify-center bg-azul-noche bg-opacity-70 backdrop-blur-sm hidden">
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-6xl relative max-h-[95vh] overflow-hidden flex flex-col border-2 border-azul-noche">
                <!-- Header del Modal -->
                <div class="bg-gradient-to-r from-azul-noche to-azul-noche px-6 py-4 flex items-center justify-between">
                    ...
                    <button id="cerrar-modal-detalles" class="text-white hover:text-amarillo hover:bg-azul-noche hover:bg-opacity-80 rounded-full p-2 transition-colors">
                        <i class="fas fa-times text-xl"></i>
                    </button>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <div id="detalles-content" class="hidden">
                        ...
                        <div class="mb-6 bg-celeste bg-opacity-30 rounded-lg p-5 border-2 border-azul-noche border-opacity-10">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Solicitante</label>
                                    <input type="text" id="detalle-solicitante" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Campaña</label>
                                    <input type="text" id="detalle-campana" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Cargo</label>
                                    <input type="text" id="detalle-cargo" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Vacantes</label>
                                    <input type="text" id="detalle-vacantes" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Experiencia</label>
                                    <input type="text" id="detalle-experiencia" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Estado</label>
                                    <input type="text" id="detalle-estado" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Inicio Capacitación</label>
                                    <input type="text" id="detalle-fecha-inicio" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche text-opacity-70 mb-1">Fin Capacitación</label>
                                    <input type="text" id="detalle-fecha-fin" class="w-full p-2 rounded-lg bg-white border-2 border-azul-noche border-opacity-20 text-azul-noche cursor-not-allowed" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="form-detalles-convocatoria">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Razón Social Interna</label>
                                    <input type="text" name="razon_social_interna" id="razon_social_interna" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Jefe Inmediato</label>
                                    <input type="text" name="jefe_inmediato" id="jefe_inmediato" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Cliente</label>
                                    <input type="text" name="cliente" id="cliente" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Servicio Asociado</label>
                                    <input type="text" name="servicio_asociado" id="servicio_asociado" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Centro de Costo</label>
                                    <input type="text" name="centro_costo" id="centro_costo" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Modalidad de Trabajo</label>
                                    <select name="modalidad_trabajo" id="modalidad_trabajo_det" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="lugar_trabajo" id="lugar_trabajo" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Región Presencial</label>
                                    <input type="text" name="region_presencial" id="region_presencial" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Contrato</label>
                                    <select name="tipo_contrato" id="tipo_contrato_det" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none">
                                        <option value="">Seleccionar</option>
                                ...
                                <div>
                                    ...
                                    <button type="button" id="btn-seleccionar-dias" class="w-full border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 rounded-lg transition-all outline-none text-left bg-white">
                                ...
                                <div>
                                    ...
                                    <input type="time" name="hora_inicio" id="hora_inicio" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Hora Fin</label>
                                    <input type="time" name="hora_fin" id="hora_fin" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Remuneración</label>
                                    <input type="number" step="0.01" name="remuneracion" id="remuneracion" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Variable</label>
                                    <input type="number" step="0.01" name="variable" id="variable" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Movilidad</label>
                                    <input type="number" step="0.01" name="movilidad" id="movilidad" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Bono Permanencia</label>
                                    <select name="bono_permanencia" id="bono_permanencia" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none">
                                        <option value="">Seleccionar</option>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Requerimiento</label>
                                    <input type="text" name="tipo_requerimiento" id="tipo_requerimiento" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Motivo Requerimiento</label>
                                    <textarea name="motivo_requerimiento" id="motivo_requerimiento" rows="3" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none"></textarea>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Fecha SLA</label>
                                    <input type="date" name="fecha_sla" id="fecha_sla" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Fecha Objetivo</label>
                                    <input type="date" name="fecha_objetivo" id="fecha_objetivo" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Proceso</label>
                                    <input type="text" name="tipo_proceso" id="tipo_proceso" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-azul-noche mb-2">Tipo de Gestión</label>
                                    <select name="tipo_gestion" id="tipo_gestion_det" class="border-2 border-azul-noche border-opacity-30 focus:border-naranja focus:ring-2 focus:ring-naranja focus:ring-opacity-30 p-3 w-full rounded-lg transition-all outline-none">
                                        <option value="">Seleccionar</option>
                            ...
                            <div class="mt-6 pt-6 border-t border-celeste flex gap-3">
                                <button type="button" id="btn-guardar-detalles" class="flex-1 bg-gradient-to-r from-verde to-verde hover:from-verde hover:to-verde hover:bg-opacity-90 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center">
                                    <i class="fas fa-save mr-2"></i>Guardar Detalles
                                </button>
                                <button type="button" id="btn-cerrar-detalles" class="bg-azul-noche bg-opacity-60 hover:bg-opacity-80 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderConvocatoriaCard(c, campanias, cargos, horarios, reclutadores_disponibles) {
            ...
            if (Array.isArray(c.turnos_labels) && c.turnos_labels.length > 0) {
                c.turnos_labels.forEach(lbl => {
                    turnos += `<span class="inline-flex items-center px-3 py-1 rounded-full bg-celeste border border-azul-noche border-opacity-30 text-azul-noche text-sm font-medium mr-2 mb-2">${lbl}</span>`;
                });
            } else {
            ...
            if (Array.isArray(c.reclutadores_asignados_labels) && c.reclutadores_asignados_labels.length > 0) {
                c.reclutadores_asignados_labels.forEach(rec => {
                    recAsignados += `<span class="inline-flex items-center px-2 py-1 rounded-full bg-verde bg-opacity-20 border border-verde text-verde text-xs font-medium mr-2 mb-2">${rec}</span>`;
                });
            } else {
                recAsignados = `<div class="flex items-center mt-2"><i class="fas fa-exclamation-circle text-amarillo mr-2"></i><p class="text-azul-noche text-sm">Sin reclutadores asignados</p></div>`;
            }
            ...
            <div class="bg-white border rounded-lg p-6 shadow-sm convocatoria-item">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="px-3 py-1 rounded-full text-sm font-semibold ${c.estado === 'Abierta' ? 'bg-verde bg-opacity-20 text-verde' : 'bg-amarillo bg-opacity-30 text-azul-noche'}">
                        ${c.estado}
                    </span>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <p class="text-azul-noche font-semibold">${c.campania_nombre}</p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500 font-semibold">CARGO</p>
                        <p class="text-azul-noche font-semibold">${c.cargo_nombre}</p>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <p class="text-xs text-azul-noche text-opacity-60 font-semibold">VACANTES</p>
                        <p class="text-azul-noche">${c.requerimiento_personal}</p>
                    </div>
                    <div>
                        <p class="text-xs text-azul-noche text-opacity-60 font-semibold">EXPERIENCIA REQUERIDA</p>
                        <p class="text-azul-noche">${c.experiencia_label}</p>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <p class="text-xs text-azul-noche text-opacity-60 font-semibold">INICIO CAPACITACIÓN</p>
                        <p class="text-azul-noche">${c.fecha_inicio_capacitacion}</p>
                    </div>
                    <div>
                        <p class="text-xs text-azul-noche text-opacity-60 font-semibold">FIN CAPACITACIÓN</p>
                        <p class="text-azul-noche">${c.fecha_fin_capacitacion}</p>
                    </div>
                </div>
                <div class="mb-4">
                    <p class="text-xs text-azul-noche text-opacity-60 font-semibold">TURNOS</p>
                    <div class="flex flex-wrap gap-2">${turnos}</div>
                </div>
                <div class="mt-6 flex items-center space-x-1 flex-wrap gap-1">
                    <button type="button" class="detalles-conv-btn bg-azul-noche hover:bg-azul-noche hover:bg-opacity-90 text-white px-2 py-0.5 rounded text-xs font-semibold shadow-sm" data-conv-id="${c.id}">
                        <i class="fas fa-info-circle mr-1"></i> Detalles
                    </button>
                    <button type="button" class="swal-assign-btn bg-celeste hover:bg-celeste hover:bg-opacity-80 text-azul-noche px-2 py-0.5 rounded text-xs font-semibold shadow-sm" data-conv-id="${c.id}" data-conv-name="${c.campania_nombre}">
                    ...
                    <form action="/convocatorias/${c.id}" method="POST" class="inline delete-conv-form">
                        ...
                        <button type="button" class="swal-delete-btn bg-naranja hover:bg-naranja hover:bg-opacity-90 text-white px-2 py-0.5 rounded text-xs font-semibold shadow-sm">
                            <i class="fas fa-trash mr-1"></i> Eliminar
                        </button>
                    </form>
                    <button type="button" class="insertar-postulante-btn bg-verde hover:bg-verde hover:bg-opacity-90 text-white px-2 py-0.5 rounded text-xs font-semibold shadow-sm" data-conv-id="${c.id}" data-conv-name="${c.campania_nombre}">
                        <i class="fas fa-user-plus mr-1"></i> Insertar Postulante
                    </button>
                </div>
                <div class="mt-4 pt-4 border-t border-celeste">
                    <p class="text-xs text-azul-noche text-opacity-60 font-semibold">RECLUTADORES ASIGNADOS</p>
        ...
        // (puedes usar event delegation si lo prefieres)
            ...
            function activateTab(name) {
                ...
                if (!tabP || !tabI || !tPost || !tIns) return;
                if (name === 'postulantes') {
                    tabP.classList.remove('hidden'); tabI.classList.add('hidden');
                    // Actualizar estilos de las pestañas
                    tPost.classList.add('border-naranja', 'text-azul-noche', 'bg-white');
                    tPost.classList.remove('border-transparent', 'text-azul-noche', 'text-opacity-60', 'bg-celeste');
                    tIns.classList.remove('border-naranja', 'text-azul-noche', 'bg-white');
                    tIns.classList.add('border-transparent', 'text-azul-noche', 'text-opacity-60');
                } else {
                    tabP.classList.add('hidden'); tabI.classList.remove('hidden');
                    // Actualizar estilos de las pestañas
                    tIns.classList.add('border-naranja', 'text-azul-noche', 'bg-white');
                    tIns.classList.remove('border-transparent', 'text-azul-noche', 'text-opacity-60', 'bg-celeste');
                    tPost.classList.remove('border-naranja', 'text-azul-noche', 'bg-white');
                    tPost.classList.add('border-transparent', 'text-azul-noche', 'text-opacity-60');
                }
            }
            ...
            async function loadModalPostulantes(convocatoriaId) {
                ...
                try {
                    ...
                    const items = data.map(p => `\n                        <div class="p-2 border-b">\n                            <div class=\"font-medium\">${escapeHtml(p.nombre_completo || p.nombres || '')}</div>\n                            <div class=\"text-sm text-gray-600\">DNI: ${escapeHtml(p.dni || '')} — Estado: ${escapeHtml(p.estado || '')}</div>\n                        </div>\n                    `).join('');
